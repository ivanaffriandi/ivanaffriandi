...
const HALLUCINATIONS = ["MISTAKE", "GETIH", "SUWUNG", "HELP", "ELING", "MATI", "SAKSI"];
  ...
  return (
    ...
    >
      <div className="border border-void-white/10 bg-[#020202] p-8 md:p-12 relative overflow-hidden group">
        <h2 className="text-7xl md:text-[10rem] font-horror mb-16 text-void-white uppercase tracking-tighter">SUKMA</h2>
          ...
          >
             ...
             <AnimatePresence>
               {isRevealing && currentMessage && (
                 ...
                 >
                    <span className="font-horror text-void-blood text-4xl md:text-8xl drop-shadow-[0_0_15px_rgba(255,0,0,0.8)] tracking-widest bg-black/40 px-6">
                      {currentMessage}
                    </span>
                 </motion.div>
               )}
             ...
             <div className="absolute top-6 left-6 bg-void-blood text-black font-syne text-[9px] px-3 py-1 z-50 font-bold uppercase tracking-[0.3em] shadow-[0_0_15px_rgba(255,0,0,0.6)]">
               {isRevealing ? 'SUKMA MELEK' : 'SENTUH AKU'}
             </div>
          </div>
          
          <div className="w-full lg:w-[55%] flex flex-col gap-12 font-special">
            <div>
              <span className="text-void-blood font-syne text-[11px] uppercase tracking-[0.5em] font-bold">Identitas</span>
            ...
            <p className="text-gray-400 leading-[1.8] text-base md:text-xl italic max-w-xl">
              "Every breath here is an offering. I am no longer Ivan. I am the echo in the corner of your eye. You touch the static and think you see a face, but you only see a mirror of your own fear. Kowe isih eling?"
            </p>
            ...
            <div className="border border-void-white/5 p-8 bg-white/[0.01] relative group overflow-hidden border-l-2 border-l-void-blood/30">
              <span className="text-[11px] text-void-blood/70 uppercase tracking-[0.4em] font-bold">Remnants</span>
              <p className="text-[14px] text-gray-700 mt-4 font-mono group-hover:text-void-blood transition-colors leading-relaxed">
                ISIH URIP... ALONE<br/>
                GETIH... THE BLOOD RUNS COLD<br/>
                SUWUNG... THE EMPTINESS IS LOUD
              </p>
            </div>
            ...
            <div className="mt-12 flex items-center gap-8 opacity-20 group-hover:opacity-100 transition-opacity">
               ...
               <span className="font-syne text-[9px] text-gray-700 tracking-[0.3em] uppercase italic">Sampun rampung?</span>
            </div>
          </div>
        </div>
      </div>
